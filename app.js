...
document.addEventListener('DOMContentLoaded', () => {
  const projectBodyText = document.querySelector('.project-body-text');
  const openOverlayButton = document.getElementById('open-overlay');
  const overlay = document.getElementById('audio-overlay');

  // Toggle the overlay and the project-body-text
  openOverlayButton.addEventListener('click', () => {
    // Toggle the overlay visibility
    overlay.classList.toggle('hidden');

    // Toggle the project-body-text visibility
    projectBodyText.classList.toggle('hidden');

    if (overlay.classList.contains('hidden')) {
      console.log('Overlay closed, project-body-text visible');
    } else {
      console.log('Overlay opened, project-body-text hidden');
    }
  });
  ...
  overlay.addEventListener('click', function (e) {
    if (e.target === overlay) {
      ...
      projectBodyText.classList.remove('hidden');
      console.log('Overlay closed by clicking outside, project-body-text visible');
    }
  });
});
